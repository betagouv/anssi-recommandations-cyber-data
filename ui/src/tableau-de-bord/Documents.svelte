...
<section class="space-y-6">
  <div class="flex flex-wrap items-center gap-4">
    ...
    <div class="flex items-center space-x-2">
      <button
        ...
        class="inline-flex items-center px-3 py-2 border text-sm font-medium rounded-md transition-colors {filtreSansChunks
      ...
      <button
        ...
        class="inline-flex items-center px-3 py-2 border text-sm font-medium rounded-md transition-colors {filtreManquants
    ...
    {#if filtreNom || filtreSansChunks || filtreManquants}
      <button
        onclick={() => {
          filtreNom = '';
          filtreSansChunks = false;
          filtreManquants = false;
        }}
  ...
  <div>
    <div
      class="bg-white shadow-sm border border-gray-200 overflow-hidden rounded-lg"
    >
      {#if documents}
