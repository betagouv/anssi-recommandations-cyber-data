  ...
  <section class="grid gap-4">
    <div class="flex flex-col gap-1.5">
      <label for="id-collection" class="text-sm font-medium text-gray-700"
        >Identifiant des documents à supprimer :</label
      >
      <textarea
        id="documents-a-supprimer"
        rows="2"
        name="documents-a-supprimer"
        bind:value={documentsASupprimer}
        placeholder="ID1, ID2..."
