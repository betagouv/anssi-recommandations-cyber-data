    ...
    return ExperienceAvecResultats(
        ...
        results=[
            MetriqueResultat(
                ...
                num_try=2,
                observation_table=[
                    ObservationResultat(score=0.8, observation="test1"),
                    ObservationResultat(score=0.9, observation="test2"),
                ],
            ),
            MetriqueResultat(
                created_at="2025-01-01T00:00:00Z",
                ...
                num_try=2,
                observation_table=[
                    ObservationResultat(score=0.7, observation="test3"),
                    ObservationResultat(score=0.6, observation="test4"),
                ],
            ),
        ],
    )
