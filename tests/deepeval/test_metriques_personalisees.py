...
def test_metriques_bon_nom_documents_en_contexte_retourne_1_si_meme_document():
    metadatas = {
        "nom_document_reponse_bot_0": "document_test",
        "nom_document_verite_terrain_0": "document_test",
        "nom_document_reponse_bot_1": "document_test1",
        "nom_document_verite_terrain_1": "document_test1",
        "nom_document_reponse_bot_2": "document_test2",
        "nom_document_verite_terrain_2": "document_test2",
        "nom_document_reponse_bot_3": "document_test3",
        "nom_document_verite_terrain_3": "document_test3",
        "nom_document_reponse_bot_4": "document_test4",
        "nom_document_verite_terrain_4": "document_test4",
    }
